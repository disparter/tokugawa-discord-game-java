...
public class ItemServiceImpl implements ItemService {
    ...
    public Player applyItemEffects(Item item, Player player) {
        log.info("Applying effects of item {} to player {}", item.getName(), player.getUsername());
    ...
    private void applyEffect(Player player, String effectType, Integer value) {
        switch (effectType) {
            case "health":
                ...
                log.info("Applied health effect of {} to player {}, new health: {}", 
