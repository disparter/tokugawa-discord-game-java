...
public class ClubCommand implements SlashCommand {
    ...
    private Mono<Void> handleListClubs(SlashCommandInteractionEvent event, Player player) {
    ...
    private Mono<Void> handleClubInfo(SlashCommandInteractionEvent event, Player player) {
    ...
    private Mono<Void> showClubInfo(SlashCommandInteractionEvent event, Club club) {
    ...
    private Mono<Void> handleJoinClub(SlashCommandInteractionEvent event, Player player) {
        Optional<ApplicationCommandInteractionOption> clubOption = 
                event.getOption("clube");
    ...
    private Mono<Void> handleLeaveClub(SlashCommandInteractionEvent event, Player player) {
        List<Club> playerClubs = clubService.getPlayerClubs(player.getId());
    ...
    private Mono<Void> handleAlliance(SlashCommandInteractionEvent event, Player player) {
    ...
    private Mono<Void> handleRivalry(SlashCommandInteractionEvent event, Player player) {
        Optional<ApplicationCommandInteractionOption> actionOption = 
                event.getOption("acao");
        Optional<ApplicationCommandInteractionOption> targetOption = 
                event.getOption("alvo");
    ...
    private Mono<Void> handleCompetition(SlashCommandInteractionEvent event, Player player) {
        Optional<ApplicationCommandInteractionOption> actionOption = 
                event.getOption("acao");
